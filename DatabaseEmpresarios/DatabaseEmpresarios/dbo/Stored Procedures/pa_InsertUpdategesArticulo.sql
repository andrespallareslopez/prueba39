...
--region [dbo].[pa_InsertUpdategesArticulo]

------------------------------------------------------------------------------------------------------------------------
-- Generated By:   andres using CodeSmith 4.0.0.0
-- Template:       StoredProcedures.cst
-- Procedure Name: [dbo].[pa_InsertUpdategesArticulo]
-- Date Generated: domingo, 21 de agosto de 2011
------------------------------------------------------------------------------------------------------------------------

CREATE PROCEDURE [dbo].[pa_InsertUpdategesArticulo]
	@CodArticulo int,
	@CodGrupo int,
	@CodFamilia int,
	@CodEnvase int,
...
IF EXISTS(SELECT [CodArticulo] FROM [dbo].[gesArticulo] WHERE [CodArticulo] = @CodArticulo)
BEGIN
